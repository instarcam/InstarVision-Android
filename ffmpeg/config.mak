...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --cross-prefix=i686-linux-android- --arch=x86 --sysroot=/Library/Developer/android-ndk-r8d/platforms/android-9/arch-x86 --disable-shared --enable-static --disable-symver --disable-asm --disable-doc --disable-bsfs --disable-indevs --disable-outdevs --disable-programs --disable-filter=showspectrum --disable-filter=dctdnoiz --disable-filter=atempo --enable-swscale --prefix=build//x86 --extra-cflags= --extra-ldflags=
prefix=build//x86
...
AS=i686-linux-android-gcc
LD=i686-linux-android-gcc
DEPCC=i686-linux-android-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=i686-linux-android-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Library/Developer/android-ndk-r8d/platforms/android-9/arch-x86 -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC
...
LD_PATH=-L
DLLTOOL=
LDFLAGS=   --sysroot=/Library/Developer/android-ndk-r8d/platforms/android-9/arch-x86 -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
